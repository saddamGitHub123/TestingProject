...
<link href="<c:url value="/resources/css/easy-responsive-tabs.css" />" rel='stylesheet' type='text/css'/>
...
<div class="header-bot">
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
          ...
          <!--<h1><a href="ShoppinHome.jsp"><span>B</span>ig Shoppy <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1> -->
			</div>
        <!-- header-bot -->
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class="active menu__item menu__item--current"><a class="menu__link" href="e_home">Home <span class="sr-only">(current)</span></a></li>
							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="mens.html"><img src="<c:url value="/resources/img/top2.jpg" />"  alt=" "/></a>
									</div>
							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									...
									<div class="col-sm-6 multi-gd-img multi-gd-text ">
										<a href="womens.html"><img src="<c:url value="/resources/img/top1.jpg" /> " alt=" "/></a>
									</div>
									<div class="clearfix"></div>
								</div>
							</ul>
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<div class="col-md-4 modal_body_right modal_body_right1">
							<img src="<c:url value="/resources/img/log_pic.jpg" />" alt=" "/>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
...
<!-- banner -->
            ...
            <div class="banner_bottom_agile_info_inner_w3ls">
    	           <div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
						<figure class="effect-roxy">
							<img src="<c:url value="/resources/img/bottom1.jpg" />" alt=" " class="img-responsive" />
							<figcaption>
					 ...
					 <div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
						<figure class="effect-roxy">
							<img src="<c:url value="/resources/img/bottom2.jpg" /> " alt=" " class="img-responsive" />
							<figcaption>
								<h3><span>F</span>all Ahead</h3>
								<p>New Arrivals</p>
							</figcaption>			
	...
	<div class="schedule-bottom">
		<div class="col-md-6 agileinfo_schedule_bottom_left">
			<img src="<c:url value="/resources/img/mid.jpg" />" alt=" " class="img-responsive" />
		</div>
		...
		<div class="col-md-5 bb-grids bb-left-agileits-w3layouts">
			<a href="womens.html">
			   <div class="bb-left-agileits-w3layouts-inner grid">
					<figure class="effect-roxy">
							<img src="<c:url value="/resources/img/bb1.jpg" />"  alt=" " class="img-responsive" />
							<figcaption>
		...
		<div class="col-md-7 bb-grids bb-middle-agileits-w3layouts">
		      <a href="mens.html">
		       <div class="bb-middle-agileits-w3layouts grid">
			           <figure class="effect-roxy">
							<img src="<c:url value="/resources/img/bottom3.jpg" />" alt=" " class="img-responsive" />
							<figcaption>
								<h3><span>S</span>ale </h3>
								<p>Upto 55%</p>
							</figcaption>			
		      ...
		      <div class="bb-middle-agileits-w3layouts forth grid">
						<figure class="effect-roxy">
							<img src="<c:url value="/resources/img/bottom4.jpg" />" alt=" " class="img-responsive">
							<figcaption>
								<h3><span>S</span>ale </h3>
								<p>Upto 65%</p>
							</figcaption>		
...
<!--/grids-->
      <div class="agile_last_double_sectionw3ls">
            <div class="col-md-6 multi-gd-img multi-gd-text ">
					<a href="womens.html"><img src="<c:url value="/resources/img/bot_1.jpg" />" alt=" "><h4>Flat <span>50%</span> offer</h4></a>
					
			</div>
			 <div class="col-md-6 multi-gd-img multi-gd-text ">
					<a href="womens.html"><img src="<c:url value="/resources/img/bot_2.jpg" />" alt=" "><h4>Flat <span>50%</span> offer</h4></a>
			</div>
			<div class="clearfix"></div>
	   </div>							
<!--/grids-->
					...
					<!--/tab_one-->
						<div class="tab1">
                            ...
                            <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/m3.jpg" /> " alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/m3.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/m5.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/m5.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/m7.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/m7.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/m6.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/m6.jpg"  />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
					 ...
					 <!--//tab_two-->
						...
						<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/b1.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/b1.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/b2.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/b2.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
                            ...
                            <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/b3.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/b3.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/b4.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/b4.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/b5.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/b5.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/b6.jpg" />"  alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/b6.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/b8.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/b8.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
						...
						<div class="tab4">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/s1.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/s1.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/s2.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/s2.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/s3.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/s3.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/s4.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/s4.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/s5.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/s5.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/s7.jpg" />"  alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/s7.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<c:url value="/resources/img/s8.jpg" />" alt="" class="pro-image-front">
										<img src="<c:url value="/resources/img/s8.jpg" />" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
