...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Book Store</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#services">Book</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <strong>WelCome to My New TestApp</strong>
            </h1>
            <hr>
          </div>
          <div class="col-lg-8 mx-auto">
            <p class="text-faded mb-5">This is the free testing api , to test all the upcoming api , you will get all the type of api ..</p>
            <a class="btn btn-primary btn-xl js-scroll-trigger" href="#about">Goto Products</a>
          </div>
        </div>
      </div>
    </header>
