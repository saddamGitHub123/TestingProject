...
<link href="<c:url value="/resources/css/team.css" />" rel="stylesheet" type="text/css" media="all" />
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class="active menu__item"><a class="menu__link" href="e_home">Home <span class="sr-only">(current)</span></a></li>
			...
			<!--/w3_short-->
				 <div class="services-breadcrumb">
						<div class="agile_inner_breadcrumb">
						   ...
						   <ul class="w3_short">
								<li><a href="e_home">Home</a><i>|</i></li>
								<li>About</li>
							</ul>
						 </div>
				</div>
	    ...
	    <div class="container">
			<div class="agile_ab_w3ls_info">
				<div class="col-md-6 ab_pic_w3ls">
				   	<img src="<c:url value="/resources/img/ab_pic.jpg" />" alt=" " class="img-responsive" />
				</div>
			...
			<div class="inner_w3l_agile_grids">
					<div class="col-md-3 team-grids">
						<div class="thumbnail team-w3agile">
							<img src="<c:url value="/resources/img/saddam.jpg" />" class="img-responsive" alt="">
				...
				<div class="col-md-5 sign-gd-two">
					...
					<div class="w3-address">
						...
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								<h6>Location</h6>
								<p> Marathallahai , Bangalore 560037 
