...
public class DateManagement implements Serializable  {
	...
	public String toString() {
		return "DateManagement [ID=" + ID + ", SP_ID=" + SP_ID + ", User_ID=" + User_ID + ", Block_Date=" + Block_Date
				+ ", Message=" + Message + "]";
	}
	
	public DateManagement() {}	
	public DateManagement(String sP_ID, String user_ID, String block_Date, String message) {
		super();
		SP_ID = sP_ID;
		User_ID = user_ID;
